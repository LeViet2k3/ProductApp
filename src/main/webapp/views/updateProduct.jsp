    ...
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        ...
        <body>
            ...
            <form:form method="POST" action="/products/updateProduct/${product.getProductID()}"
                ...
                <form:input type="text" value="${product.getProductName()}" placeholder="Enter product's name"
                    path="productName" /><br>
                <form:errors path="productName" cssClass="error" /> <br>
                <form:input type="number" value="${product.getPrice()}" placeholder="Enter product's price"
                    path="price" /><br />
                <form:errors path="price" cssClass="error" /> <br>
                <form:input type="text" value="${product.getDescription()}" placeholder="Enter description"
                    path="description" /><br />
